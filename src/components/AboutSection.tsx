...
const AboutSection = () => {
  return (
    <section className="relative py-16 md:py-24 bg-gradient-to-br from-purple-50/80 via-background to-blue-50/60 overflow-hidden">
      {/* Decorative elements */}
      <PaintSplash className="absolute -top-6 -right-6 w-36 h-36 text-primary/10 animate-splash-in" />
      <PaintSplash className="absolute -bottom-8 -left-8 w-28 h-28 text-secondary/10 animate-splash-in" style={{ animationDelay: "0.4s" }} />
      <div className="absolute top-20 right-20 text-2xl opacity-20 animate-float" style={{ animationDelay: "0.3s" }}>🎨</div>
      <div className="absolute bottom-10 left-10 text-xl opacity-15 animate-float" style={{ animationDelay: "1s" }}>✨</div>
