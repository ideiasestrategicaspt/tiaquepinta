...
const TestimonialsSection = () => {
  ...
  return (
    <section className="relative py-16 md:py-24 bg-gradient-to-br from-blue-50/50 via-background to-purple-50/50 overflow-hidden">
      {/* Paint effects */}
      <PaintSplash className="absolute -top-6 -right-8 w-44 h-44 text-primary/25 animate-splash-in" />
      <BrushStroke className="absolute top-10 left-0 w-64 text-accent" />
      <PaintSplash className="absolute -bottom-8 -left-6 w-36 h-36 text-secondary/25 animate-splash-in" style={{ animationDelay: "0.5s" }} />
      <div className="absolute top-8 right-12 text-4xl opacity-40 animate-float">⭐</div>
      <div className="absolute bottom-12 left-8 text-3xl opacity-40 animate-float" style={{ animationDelay: "0.5s" }}>🎨</div>
      <div className="absolute top-1/2 left-20 text-3xl opacity-35 animate-float" style={{ animationDelay: "1s" }}>✨</div>
      <div className="absolute top-1/3 right-6 text-3xl opacity-30 animate-float" style={{ animationDelay: "0.8s" }}>🖌️</div>
      <div className="absolute bottom-1/4 right-1/4 text-2xl opacity-30 animate-float" style={{ animationDelay: "1.3s" }}>🎈</div>
