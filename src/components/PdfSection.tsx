...
const PdfSection = () => {
  return (
    <section className="relative py-10 md:py-24 bg-gradient-to-br from-muted via-white to-muted overflow-hidden">
      ...
      <div className="absolute top-12 right-16 text-3xl animate-float">🖌️</div>
      <div className="absolute bottom-16 left-12 text-3xl animate-float" style={{ animationDelay: "0.9s" }}>⭐</div>
      <div className="absolute top-1/3 left-8 text-3xl animate-float" style={{ animationDelay: "0.5s" }}>🎨</div>
      <div className="absolute bottom-1/3 right-10 text-2xl animate-float" style={{ animationDelay: "1.2s" }}>✨</div>
