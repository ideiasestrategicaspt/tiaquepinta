...
const CourseContentSection = () => {
  return (
    <section className="relative py-16 md:py-24 bg-gradient-to-b from-background via-purple-50/40 to-background overflow-hidden">
      ...
      <div className="absolute top-2 left-2 md:top-8 md:left-2 text-xl md:text-4xl animate-float">🖌️</div>
      <div className="absolute top-2 right-2 md:bottom-10 md:right-4 md:top-auto text-xl md:text-3xl animate-float" style={{ animationDelay: "0.7s" }}>⭐</div>
      <div className="absolute bottom-2 right-2 md:top-1/3 md:right-2 md:bottom-auto text-xl md:text-3xl animate-float" style={{ animationDelay: "1.2s" }}>✨</div>
      <div className="absolute bottom-2 left-2 md:bottom-1/3 md:left-2 text-xl md:text-3xl animate-float" style={{ animationDelay: "0.5s" }}>🎨</div>
